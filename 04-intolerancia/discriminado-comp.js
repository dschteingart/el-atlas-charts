// =============================================================
//  El Atlas N°4 — Comparación: grupo discriminado (chart 16)
// =============================================================
//
...
function drawDiscriminadoComp() {
  ...
  // Títulos NEUTRALES por default (norma del N°4).
...
function setupDiscriminadoCompCSV() {
  document.querySelectorAll('button.download[data-chart="16-csv"]').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = lang === 'en'
        ? 'the-atlas-04-discriminated-group-comparison.csv'
        : 'el-atlas-04-grupo-discriminado-comparacion.csv';
