// Strings del chart 17 del N°4 — "Evolución": el barrio entre las dos olas del
...
(function () {
  ...
  Object.assign(I18N.es, {
    ...
    'c17-sources-tpl':   'Datos: World Values Survey, «{ITEM}». % «muy/bastante seguido», olas 6 (2010-2016) y 7 (2017-2023), cada punto en el año real de campo. Mide saliencia percibida, no prevalencia.',
  });
  ...
  Object.assign(I18N.en, {
    ...
    'c17-sources-tpl':   'Data: World Values Survey, "{ITEM}". % "very/quite frequently", waves 6 (2010-2016) and 7 (2017-2023), each point at the actual fieldwork year. Measures perceived salience, not prevalence.',
  });
})();
