...
Object.assign(I18N.en, {
  ...
  'c7-sources':     'Data: Integrated Values Survey (WVS/EVS, 1981-2022), waves 2 to 7. Two statements from the same battery: "when jobs are scarce, employers should give priority to [nation] people over immigrants" and "…men should have more right to a job than women." The chart shows the % answering "agree" out of all valid responses (agree / neither / disagree): the "neither" stays in the denominator. Weighted % (S017); only cells with at least 200 cases. The horizontal axis is the <em>real survey year</em>, not the wave number (waves do not line up across countries). Priority for the native-born: 115 countries, 390 measurements; priority for men: 117 countries. With about 1,000 cases per point the standard error is around 1.6 points: shifts of a few points are not informative. Any regional average requires a balanced panel of countries, since the sample grows from about 42 countries in wave 2 to about 92 in wave 7. Measures attitudes <em>declared</em> to an interviewer.'
});
