...
(function () {
  ...
  Object.assign(I18N.en, {
    ...
    'c14-sources':       'Data: Integrated Values Survey (WVS/EVS, 1981-2022). Two statements from the same battery: "when jobs are scarce, employers should give priority to [nation] people over immigrants" (C002) and "…men should have more right to a job than women" (C001). The chart shows the % answering "agree" out of all valid responses (agree / neither / disagree): the "neither" stays in the denominator. Weighted % (S017); only cells with at least 200 cases. <strong>Each country contributes its latest available reading, so the years do not line up</strong> (Argentina 2017, Uruguay 2022, Sweden 2017…): hover over each bar to see the year. Nothing is interpolated and no common-year snapshot is constructed. Priority for the native-born: 115 countries; priority for men: 117 countries. The world median and the rank are computed over those countries. With about 1,000 cases per reading the standard error is around 1.6 points: gaps of a few points between countries are not informative. Measures attitudes <em>declared</em> to an interviewer.',
