...
Uso: editar LANDERS abajo y correr `python make_lander.py`. Salen en 04-intolerancia/v/.
El PNG de OG (thumbs/chart-vecinos-<slug>.png) se genera aparte (pasada de thumbnails).
"""
import os

BASE_URL = "https://dschteingart.github.io/el-atlas-charts/04-intolerancia"
...
LANDERS = [
    ("vecinos-mapa", "mapa", "otra_raza",
     "El mapa mundial de la intolerancia declarada — El Atlas · N°4",
    ...
    ("vecinos-evolucion", "pelicula", "homosexuales",
     "El derrumbe del rechazo a los homosexuales — El Atlas · N°4",
