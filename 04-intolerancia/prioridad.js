// =============================================================
//  El Atlas N°4 — Chart 7: "Primero los de acá" (líneas temporales)
// =============================================================
...
// Clon del motor de la película N°4 (pelicula.js): slider de período, hover por
...
function drawPrioridad() {
  ...
  // título insight→neutral: neutral por default (decisión editorial del N°4)
...
function pr_setupHover(svg, ctx) {
  ...
  function update(rawYear) {
    ...
    rows.forEach(r => {
      ...
      const c = pr_ns('circle'); c.setAttribute('cx', xScale(r.year)); c.setAttribute('cy', yScale(r.value)); c.setAttribute('r', 4);
...
function setupPrioridadCSV() {
  document.querySelectorAll('button.download[data-chart="7-csv"]').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      a.download = lang === 'en' ? 'the-atlas-04-jobs-priority.csv' : 'el-atlas-04-prioridad-empleo.csv';
