// =============================================================
//  El Atlas N°4 — Chart 11: sentirse parte de un grupo discriminado
// =============================================================
...
function setupDiscriminadoCSV() {
  document.querySelectorAll('button.download[data-chart="11-csv"]').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      a.download = lang === 'en' ? 'the-atlas-04-discriminated-group.csv' : 'el-atlas-04-grupo-discriminado.csv';
