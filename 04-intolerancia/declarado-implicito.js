// =============================================================
//  El Atlas N°4 — Chart 5: declarado vs implícito (scatter)
// =============================================================
...
// =================== Leyenda ===================
// Dentro del SVG (png-export no dibuja leyenda propia en el N°4) pero FUERA del
...
function setupScatterCSV() {
  document.querySelectorAll('button.download[data-chart="5-csv"]').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      a.download = lang === 'en' ? 'the-atlas-04-declared-vs-implicit.csv' : 'el-atlas-04-declarado-vs-implicito.csv';
