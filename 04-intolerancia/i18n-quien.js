...
Object.assign(I18N.es, {
  ...
  // ---- Fuentes / metodología
  'c12-sources':        'Datos: Latinobarómetro 2020, pregunta P58ST: «¿Cuáles cree Ud. que son las personas o grupos más discriminados en el país?». Es de <strong>respuesta única</strong>: cada persona nombró un solo grupo, así que los porcentajes de un país suman 100. 18 países de América Latina, % ponderado (wt) sobre 16.752 respuestas válidas; el 17,1% no sabe o no responde. El recodeo de las 42 categorías originales es nuestro, no del Latinobarómetro: «Ranking», «Perfil» y el CSV las muestran agrupadas en doce, y la «Matriz» dibuja ocho porque ahí «Otros» suma además ideología política, conducta o estigma, salud o discapacidad y religión u origen. «Ninguno» es una respuesta sustantiva: nadie es discriminado. Mide a quién <em>señala</em> la gente, no quién sufre más discriminación, y sólo hay 2020: el menú de categorías se diseñó para esa ronda.',
...
Object.assign(I18N.en, {
  ...
  'c12-sources':        'Data: Latinobarómetro 2020, question P58ST: “Which people or groups do you think are the most discriminated against in the country?”. It is a <strong>single-answer</strong> question: each respondent named one group only, so a country’s shares add up to 100. 18 Latin American countries, weighted % (wt) over 16,752 valid answers; 17.1% don’t know or no answer. The recoding of the 42 original categories is ours, not Latinobarómetro’s: “Ranking”, “Profile” and the CSV show them grouped into twelve, and the “Matrix” draws eight because there “Others” also adds up political ideology, behaviour or stigma, health or disability and religion or origin. “None” is a substantive answer: no group is discriminated against. This measures who people <em>name</em>, not who suffers the most discrimination, and 2020 is the only round: the category menu was designed for it.',
