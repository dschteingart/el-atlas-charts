// Strings del N°4 "¿Somos tan intolerantes?" + helpers i18n.
...
const ISSUE_I18N = {
  es: {
    ...
    'c1-refs-label':     'Referencias',
    'c1-ref-median':   'Línea mundial',
    'c1-stat-label':   'Estadístico',
    'c1-stat-median':  'Mediana',
    'c1-stat-mean':    'Promedio',
    'c1-median-table-title': 'Mediana por región',
    'c1-mean-lbl':     'Promedio mundial',
    'c1-ref-table':      'Tabla regional',
    ...
    'c6-subtitle-lines': 'Evolución del rechazo a {CAT} como vecinos en América Latina, según Latinobarómetro (1998-2024).',
    'c6-view-label':     'Ver',
    'c6-view-bars':      'Ranking 2024',
    'c6-view-lines':     'Evolución',
    'c6-axis-x':         '% que no lo querría de vecino',
    'c6-tt-survey':      'Encuesta',
    'c6-sources':        'Datos: Latinobarómetro 2024 (batería P3NOIJ, la misma pregunta de vecinos del WVS), muestras nacionales de 1.000-1.200 casos por país. % ponderado sobre quienes respondieron la batería. Es otra encuesta, con otro operativo de campo y dato más reciente que la IVS: sirve para comprobar que el ranking regional no depende de una sola fuente.',
    ...
    // Tabs del graficador (vecinos, V-Dem, WRP). Nunca estuvieron en el
    // diccionario: en inglés quedaban en castellano (reporte de Daniel).
    'g-tabs-aria': 'Ver como',
  ...
  en: {
    ...
    'c1-median-on':      'Show',
    'c1-median-off':     'Hide',
    'c1-refs-label':     'References',
    'c1-ref-median':   'World line',
    'c1-stat-label':   'Statistic',
    'c1-stat-median':  'Median',
    'c1-stat-mean':    'Mean',
    'c1-median-table-title': 'Regional median',
    'c1-mean-lbl':     'World mean',
    'c1-ref-table':      'Regional table',
    ...
    'c6-subtitle-lines': 'How rejection of {CAT} as neighbours evolved in Latin America, per Latinobarómetro (1998-2024).',
    'c6-view-label':     'View',
    'c6-view-bars':      '2024 ranking',
    'c6-view-lines':     'Trend',
    'c6-axis-x':         '% who would not want them as neighbours',
    'c6-tt-survey':      'Survey',
    'c6-sources':        'Data: Latinobarómetro 2024 (P3NOIJ battery, the same neighbours question as the WVS), national samples of 1,000-1,200 per country. Weighted % over those who answered the battery. A different survey, with its own fieldwork and more recent data than the IVS: it shows the regional ranking does not hinge on a single source.',
