...
(function () {
  ...
  Object.assign(I18N.es, {
    ...
    'c26-legend-reg':     'Posición entre las nueve regiones',
    'c26-legend-paises':  'Posición entre los países del mundo',
    'c26-niv-bajo':       'bajo',
    ...
    'c26-sources-png-reg':    'Qué mide cada columna: % que no querría de vecino a una persona de otra raza · % que dice ver conductas racistas muy o bastante seguido en su barrio · % que dice haber sufrido discriminación por su color de piel alguna vez · índice de V-Dem (0 a 1) sobre cuánto se le niega el acceso a servicios, empleo público, poder político y libertades civiles por el grupo social al que se pertenece · Gini ajustado por diferencias entre consumo e ingresos. Datos: Integrated Values Survey y World Values Survey (último dato por país, 2010-2023), World Risk Poll 2023, V-Dem v16 (2023) y PIP-Banco Mundial. Promedio simple de los países de cada región con dato. El nivel compara a las nueve regiones entre sí dentro de cada columna. Las cinco columnas no cubren los mismos países.',
  ...
  Object.assign(I18N.en, {
    ...
    'c26-legend-reg':     'Position among the nine regions',
    'c26-legend-paises':  'Position among the world’s countries',
    'c26-niv-bajo':       'low',
    ...
    'c26-sources-png-reg':    'What each column measures: % who would not want a neighbour of another race · % who say racist behaviour happens very or quite frequently in their area · % who say they have ever faced discrimination over their skin colour · V-Dem index (0 to 1) of how far people are denied access to services, public jobs, political power and civil liberties because of their social group · Gini adjusted for differences between consumption and income. Data: Integrated Values Survey and World Values Survey (latest available data per country, 2010-2023), World Risk Poll 2023, V-Dem v16 (2023) and PIP-World Bank. Simple average of the countries in each region with data. The level compares the nine regions against each other within each column. The five columns do not cover the same countries.',
