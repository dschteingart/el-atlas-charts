// =============================================================
//  El Atlas N°4 — Chart 8: qué ve cada sociedad en su propio barrio
// =============================================================
...
function drawBarrio() {
  ...
  // título insight→neutral (default NEUTRAL, como el resto de los charts del N°4)
...
function setupBarrioCSV() {
  document.querySelectorAll('button.download[data-chart="8-csv"]').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      a.download = lang === 'en' ? 'the-atlas-04-neighbourhood.csv' : 'el-atlas-04-barrio.csv';
