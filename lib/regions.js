...
// Los mismos colores, aclarados lo justo para TEXTO sobre el TOOLTIP OSCURO
// (fondo var(--ink) #1A1A1A). Los de arriba están calibrados para el fondo
// crema: dentro del tooltip, 6 de las 10 regiones quedaban bajo 4.5:1 de
// contraste (NA/ANZ 2.4, MENA 3.0, África Subsah. 3.3 — ilegibles). Estos
// llegan a ≥4.6 manteniendo el tono; los que ya pasaban quedan idénticos.
// (Mismo patrón que REGION_WB_COLORS_ON_DARK del N°2 y SC_CONF_COLORS_ON_DARK
// del N°3.) Usarlos SIEMPRE que un color de región vaya como texto en tooltip.
const REGION_COLORS_ON_DARK = {
  'Latin America':                          '#CC693D',
  'Caribbean':                              '#D89968',
  'North America, Australia & New Zealand': '#628AA6',
  'Western Europe':                         '#6B899D',
  'Eastern Europe & Central Asia':          '#8FA29A',
  'East Asia':                              '#C9A654',
  'Southeast Asia':                         '#A88361',
  'South Asia':                             '#A77A56',
  'Middle East & North Africa':             '#9978A1',
  'Sub-Saharan Africa':                     '#62906D'
};
