// SVG export COMPARTIDO de El Atlas (lib/) — N°3 y N°2 (el especial no lo
// usa: el botón del editor solo aparece para los chartIds mapeados).
// Unificado en la Fase 2 de la auditoría (2026-07).
//
...
(function setupSVGExport() {
  // Detección del número (mismo criterio que lib/png-export.js): el N°3
  // define CONF_FIFA_ORDER; si no está, asumimos N°2.
  const SVG_IS_N3 = typeof CONF_FIFA_ORDER !== 'undefined';
  // Mismos nombres que el export PNG (lib/png-export.js), con extensión .svg.
  const FILENAMES = SVG_IS_N3 ? {
    ...
    '5': 'el-atlas-03-elo-trayectorias.svg',
    '6': 'el-atlas-03-natividad.svg',
    '7': 'el-atlas-03-ligas.svg',
    '8': 'el-atlas-03-mapa-nacimientos.svg',
    '9': 'el-atlas-03-origenes.svg',
    '10': 'el-atlas-03-altura.svg',
    '11': 'el-atlas-03-tecnicos.svg',
    '12': 'el-atlas-03-edad.svg'
  } : {
    '1': 'el-atlas-02-gini-ranking.svg',
    '2': 'el-atlas-02-gini-vs-pib.svg',
    '3': 'el-atlas-02-deciles.svg'
  };
  ...
  function downloadChartSVG(chartId) {
    ...
    a.href = url;
    a.download = FILENAMES[chartId] || ('el-atlas-chart-' + chartId + '.svg');
