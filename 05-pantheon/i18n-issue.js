...
const ISSUE_I18N = {
  es: {
    ...
    'top-subtitle': 'Las figuras más célebres de la historia según el índice de fama de El Atlas. Elegí cuántas ver y filtrá por región, país, dominio u ocupación.',
    'top-lbl-n': 'Mostrar',
    ...
    'top-col-dom': 'Dominio',
    'top-col-score': 'Fama',
    'top-aviso-corte': 'La selección agota el corte: se muestran {n} de las 5.000 figuras más célebres.',
    'top-note': 'Fama = índice de El Atlas (0–100): amplitud de idiomas y lecturas de Wikipedia fuera del inglés, con corrección por antigüedad. No es el HPI que publica Pantheon. Universo: las 5.000 figuras más célebres de la base depurada (solo multiidioma). El puesto (#) es el ranking global.',
    'top-sources': 'Datos: Pantheon (Datawheel), índice de fama de El Atlas.',
  ...
  en: {
    ...
    'top-subtitle': "History's most famous figures according to The Atlas fame index. Choose how many to see and filter by region, country, domain or occupation.",
    'top-lbl-n': 'Show',
    ...
    'top-col-dom': 'Domain',
    'top-col-score': 'Fame',
    'top-aviso-corte': 'The selection exhausts the cutoff: showing {n} of the 5,000 most famous figures.',
    'top-note': "Fame = The Atlas index (0–100): breadth of languages and Wikipedia readership outside English, with an age correction. It is not the HPI Pantheon publishes. Universe: the 5,000 most famous figures of the cleaned dataset (multilingual only). The rank (#) is global.",
    'top-sources': 'Data: Pantheon (Datawheel), The Atlas fame index.',
