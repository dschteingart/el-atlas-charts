...
const ISSUE_I18N = {
  es: {
    ...
    'cevo-vacio': 'Elegí países o regiones con el buscador, o volvé al Mundo.',
    'cevo-note': 'Figuras célebres agrupadas por período de nacimiento: un solo tramo hasta 1500 y tramos de 50 años desde entonces. En la apertura por ocupación, cada franja es una ocupación y el tono indica su dominio. Con dos o más selecciones, un panel por cada una con la misma escala. Universo: toda la base depurada (116.319 figuras multiidioma).',
    'cevo-sources': 'Datos: Pantheon (Datawheel).',
    'cevo-png-note': 'Datos: Pantheon (Datawheel). Figuras por período de nacimiento; hasta 1500 en un solo tramo.',
  ...
  en: {
    ...
    'cevo-mundo': 'World',
    'cevo-limpiar': 'Clear',
    'cevo-vacio': 'Pick countries or regions with the search box, or go back to World.',
    'cevo-note': 'Famous figures grouped by birth period: a single bucket until 1500 and 50-year bins afterwards. In the occupation breakdown each band is one occupation, shaded by its domain. With two or more selections, one panel each on a shared scale. Universe: the full cleaned dataset (116,319 multilingual figures).',
    'cevo-sources': 'Data: Pantheon (Datawheel).',
    'cevo-png-note': 'Data: Pantheon (Datawheel). Figures by birth period; until 1500 as a single bucket.',
