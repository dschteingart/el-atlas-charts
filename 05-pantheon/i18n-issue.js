...
const ISSUE_I18N = {
  es: {
    ...
    'cevo-png-note': 'Datos: Pantheon (Datawheel), base editada por El Atlas. Se toman personas con entrada de Wikipedia en al menos dos idiomas con más de mil lecturas. Pre-1500 en un solo tramo.',
  ...
  en: {
    ...
    'cevo-png-note': 'Data: Pantheon (Datawheel), dataset edited by The Atlas. Includes people whose Wikipedia entry exists in at least two languages with over 1,000 reads. Pre-1500 as a single bucket.',
