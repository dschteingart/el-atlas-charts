...
const ISSUE_I18N = {
  es: {
    ...
    'index-lab': 'Mové los parámetros del índice en el laboratorio →',
    'index-lab-href': './fame-lab.html',
    ...
    // ---- composicion.html (de que esta hecha la fama) ----
    'ccomp-title': 'Los famosos latinoamericanos son mayormente deportistas',
    'ccomp-lbl-vista': 'Vista', 'ccomp-pais': 'País', 'ccomp-region': 'Región',
    'ccomp-lbl-medida': 'Medida', 'ccomp-share': '% del total', 'ccomp-abs': 'Absoluto', 'ccomp-percap': 'Per cápita',
    'ccomp-lbl-apertura': 'Apertura', 'ccomp-total': 'Total', 'ccomp-rubros': 'Rubros', 'ccomp-ocupaciones': 'Ocupaciones',
    'ccomp-lbl-rubro': 'Rubro', 'ccomp-lbl-periodo': 'Nacidos entre',
    'ccomp-lbl-paises': 'Países', 'ccomp-buscar': 'Agregar país…',
    'ccomp-sources': 'Datos: Pantheon (Datawheel), que toma personas con entrada de Wikipedia en al menos 15 idiomas; El Atlas depura la base y exige al menos dos idiomas con más de mil lecturas.',
    'ccomp-png-note': 'Datos: Pantheon (Datawheel), que toma personas con entrada de Wikipedia en al menos 15 idiomas; El Atlas depura la base y exige al menos dos idiomas con más de mil lecturas.',
    // ---- fame-lab.html (laboratorio del indice) ----
    'clab-title': 'Laboratorio del índice de fama',
    'clab-sub': 'El índice del número, con todas sus perillas a la vista. Se arma desde las visitas por idioma y por mes que publica Pantheon: <b>Lenguas</b> (promedio de idiomas y de idiomas con 10.000 visitas o más) × <b>Vistas</b> (media geométrica de los últimos 12 meses, el acumulado y la mediana mensual) × <b>Edad</b>. El preset <b>Publicado</b> reproduce exactamente el dataset del número.',
    'clab-presets': 'Presets', 'clab-knobs': 'Perillas', 'clab-filtros': 'Filtros',
    'clab-p-pub': 'Publicado (T40) ★', 'clab-p-hpi': 'Estilo HPI (T70)', 'clab-p-noage': 'Sin edad', 'clab-p-simple': 'Media simple',
    'clab-k-T': 'Umbral de edad (años)', 'clab-k-T-h': 'debajo de T se penaliza (el HPI usa 70)',
    'clab-k-piso': 'Piso de edad', 'clab-k-piso-h': 'cuánto conserva la figura más joven (0,5 = la mitad)',
    'clab-k-wA': 'Peso del premio por antigüedad', 'clab-k-wA-h': 'cuánto premia ser viejo',
    'clab-k-wRec': 'Peso de la penalidad por reciente', 'clab-k-wRec-h': 'cuánto castiga ser joven',
    'clab-geom': 'Media geométrica (si no, promedio simple)',
    'clab-f-dom': 'Rubro', 'clab-f-occ': 'Ocupación', 'clab-f-reg': 'Región', 'clab-f-cty': 'País',
    'clab-f-per': 'Período de nacimiento', 'clab-f-multi': 'Solo multiidioma',
    'clab-f-multi-h': '(2 idiomas o más con 1.000 visitas o más desde 2015: saca la inflación de una sola Wikipedia)',
    'clab-todos': 'Todos', 'clab-todas': 'Todas',
    'clab-th-fig': 'Figura', 'clab-th-occ': 'Ocupación', 'clab-th-nac': 'Nac.',
    'clab-th-len': 'Lenguas', 'clab-th-vis': 'Vistas', 'clab-th-edad': 'Edad×', 'clab-th-score': 'Score',
    'clab-tt-len': 'Promedio de idiomas y de idiomas con 10.000 visitas o más, normalizados. 0 a 1.',
    'clab-tt-vis': 'Media geométrica de visitas de 12 meses, acumuladas y mediana mensual, sin inglés. 0 a 1.',
    'clab-tt-edad': 'Multiplicador de antigüedad, entre el piso y 1.',
    'clab-tt-score': 'Lenguas × Vistas × Edad, reescalado a 100.',
    'clab-count': '{n} figuras en la vista · el puesto y el índice son globales (el filtro recorta, no recalcula)',
    'clab-bc': 'a.C.',
    'clab-volver': 'Volver a los gráficos',
    ...
    'cmap-lbl-filtro': 'Rubro u ocupación',
    ...
    'pod-png-note': 'Datos: Pantheon (Datawheel). El HPI combina en cuántos idiomas está la entrada de Wikipedia de cada figura, cuántas lecturas tiene y cuán antigua es.',
  ...
  en: {
    ...
    'index-lab': 'Move the index parameters in the lab →',
    'index-lab-href': './fame-lab.html?lang=en',
    'index-see':  'See chart →',
    ...
    'ccomp-lbl-rubro': 'Field', 'ccomp-lbl-periodo': 'Born between',
    'ccomp-lbl-paises': 'Countries', 'ccomp-buscar': 'Add a country…',
    'ccomp-sources': 'Data: Pantheon (Datawheel), which includes people with a Wikipedia entry in at least 15 languages; The Atlas edits the dataset and requires at least two languages with over 1,000 reads.',
    'ccomp-png-note': 'Data: Pantheon (Datawheel), which includes people with a Wikipedia entry in at least 15 languages; The Atlas edits the dataset and requires at least two languages with over 1,000 reads.',
    // ---- fame-lab.html ----
    'clab-title': 'Fame index lab',
    'clab-sub': 'The issue\u2019s index with every knob exposed. It is built from the pageviews by language and month that Pantheon publishes: <b>Languages</b> (average of languages and of languages with 10,000 views or more) × <b>Views</b> (geometric mean of the last 12 months, the all-time total and the monthly median) × <b>Age</b>. The <b>Published</b> preset reproduces the issue\u2019s dataset exactly.',
    'clab-presets': 'Presets', 'clab-knobs': 'Knobs', 'clab-filtros': 'Filters',
    'clab-p-pub': 'Published (T40) ★', 'clab-p-hpi': 'HPI style (T70)', 'clab-p-noage': 'No age', 'clab-p-simple': 'Plain average',
    'clab-k-T': 'Age threshold (years)', 'clab-k-T-h': 'below T there is a penalty (the HPI uses 70)',
    'clab-k-piso': 'Age floor', 'clab-k-piso-h': 'how much the youngest figure keeps (0.5 = half)',
    'clab-k-wA': 'Weight of the age reward', 'clab-k-wA-h': 'how much being old is rewarded',
    'clab-k-wRec': 'Weight of the recency penalty', 'clab-k-wRec-h': 'how much being young is penalised',
    'clab-geom': 'Geometric mean (otherwise plain average)',
    'clab-f-dom': 'Field', 'clab-f-occ': 'Occupation', 'clab-f-reg': 'Region', 'clab-f-cty': 'Country',
    'clab-f-per': 'Birth period', 'clab-f-multi': 'Multilingual only',
    'clab-f-multi-h': '(2 or more languages with 1,000 views or more since 2015: removes single-Wikipedia inflation)',
    'clab-todos': 'All', 'clab-todas': 'All',
    'clab-th-fig': 'Figure', 'clab-th-occ': 'Occupation', 'clab-th-nac': 'Born',
    'clab-th-len': 'Languages', 'clab-th-vis': 'Views', 'clab-th-edad': 'Age×', 'clab-th-score': 'Score',
    'clab-tt-len': 'Average of languages and of languages with 10,000 views or more, normalised. 0 to 1.',
    'clab-tt-vis': 'Geometric mean of 12-month, all-time and median monthly views, excluding English. 0 to 1.',
    'clab-tt-edad': 'Age multiplier, between the floor and 1.',
    'clab-tt-score': 'Languages × Views × Age, rescaled to 100.',
    'clab-count': '{n} figures in view · rank and index are global (the filter trims, it does not recompute)',
    'clab-bc': 'BC',
    'clab-volver': 'Back to the charts',
    'cmap-lbl-vista': 'View',
    'cmap-pais': 'Country',
    'cmap-region': 'Region',
    ...
    'cmap-lbl-filtro': 'Field or occupation',
    ...
    'pod-note': "The Historical Popularity Index (HPI, 0–100) is computed from the number of languages in which each figure is read on Wikipedia, their non-English pageviews (last year, all-time and monthly median) and an age correction. It is a modified version of the index Pantheon computes; the differences are covered in the issue's methodological note. The rank (#) is global among the 116,319 figures in the dataset.",
    ...
    'pod-png-note': 'Data: Pantheon (Datawheel). The HPI combines how many languages a figure\u2019s Wikipedia entry exists in, how much it is read and how old the figure is.',
