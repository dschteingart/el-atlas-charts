...
const ISSUE_I18N = {
  es: {
    ...
    'cevo-title': 'De qué está hecha la fama',
    ...
    'cevo-vacio': 'Elegí países o regiones con el buscador (Mundo también está ahí).',
    'cevo-note': 'Figuras célebres agrupadas por período de nacimiento: un solo tramo pre-1500 y tramos de 50 años desde entonces (post-2000 agrupa el final). En la apertura por ocupación, cada franja es una ocupación y el tono indica su dominio. Con dos o más selecciones, un panel por cada una con la misma escala. Universo: toda la base depurada (116.319 figuras multiidioma).',
    'cevo-sources': 'Datos: Pantheon (Datawheel).',
    'cevo-png-note': 'Datos: Pantheon (Datawheel). Figuras por período de nacimiento; pre-1500 en un solo tramo.',
    ...
    'pod-sources': 'Datos: Pantheon (Datawheel).',
    ...
    'rep-note': 'Cómo leerlo. «Hasta» = figuras nacidas antes del año de corte; «Desde» = nacidas en ese año o después. Cada columna suma ~100% sobre el total mundial de figuras de esa era con país de nacimiento conocido. Δ = puntos porcentuales que ganó (terracota) o perdió (azul) el grupo entre las dos eras. Universo: base depurada del N°5 (solo figuras multiidioma), la misma del mapa; nacimientos de −3500 a 2021. Dominios: reagrupamiento propio sobre las ocupaciones de Pantheon.',
    'rep-sources': 'Datos: Pantheon (Datawheel), fama reconstruida por El Atlas.',
  ...
  en: {
    ...
    'cevo-title': 'What fame is made of',
    ...
    'cevo-limpiar': 'Clear',
    'cevo-vacio': 'Pick countries or regions with the search box (World is in there too).',
    'cevo-note': 'Famous figures grouped by birth period: a single pre-1500 bucket and 50-year bins afterwards (post-2000 groups the tail). In the occupation breakdown each band is one occupation, shaded by its domain. With two or more selections, one panel each on a shared scale. Universe: the full cleaned dataset (116,319 multilingual figures).',
    'cevo-sources': 'Data: Pantheon (Datawheel).',
    'cevo-png-note': 'Data: Pantheon (Datawheel). Figures by birth period; pre-1500 as a single bucket.',
    ...
    'pod-sources': 'Data: Pantheon (Datawheel).',
    ...
    'rep-note': 'How to read it. "Before" = figures born before the cutoff year; "Since" = born in that year or later. Each column adds up to ~100% of the world total of figures of that era with a known birth country. Δ = percentage points gained (terracotta) or lost (blue) between the two eras. Universe: issue N°5 cleaned dataset (multilingual figures only), same as the map; births from −3500 to 2021. Domains: our own regrouping of Pantheon occupations.',
    'rep-sources': 'Data: Pantheon (Datawheel), fame rebuilt by The Atlas.',
