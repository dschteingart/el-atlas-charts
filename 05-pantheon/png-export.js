...
(function setupPNGExport() {
  ...
  // Filenames bilingües por chart (N°5 "Talento").
  const FILENAMES = {
    '1': { es: 'el-atlas-05-abanico-talento.png',   en: 'the-atlas-05-talent-fan.png'          },
    ...
    'evo': { es: 'el-atlas-05-perfil-de-la-fama.png', en: 'the-atlas-05-fame-profile.png' },
    'map': { es: 'el-atlas-05-mapa-fama.png', en: 'the-atlas-05-fame-map.png' },
    'comp': { es: 'el-atlas-05-composicion-fama.png', en: 'the-atlas-05-fame-composition.png' }
  };
  ...
  function legendItems() {
    // Chart 5: las 10 regiones del Atlas (lib/regions.js). Nombres traducidos
    // en BASE_I18N con las keys 'reg.<nombre>'.
    const order = (typeof REGION_ORDER !== 'undefined') ? REGION_ORDER : [];
    return order.map(reg => ({
      color: (typeof REGION_COLORS !== 'undefined' && REGION_COLORS[reg]) || '#888',
      label: t('reg.' + reg)
    }));
  }
