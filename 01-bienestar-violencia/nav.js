// =============================================================
//  El Atlas N°1 — navegación entre gráficos (estilo OWID) + CTA Substack
// =============================================================
...
(function () {
  ...
  const INDEX = './index.html';       // índice de esta entrega
  ...
  // En páginas de gráfico, hacer del "El Atlas · N° 2" de la top-bar un link al
  // índice (patrón logo→home), para volver al listado al entrar directo desde un
  // link compartido. Idempotente.
