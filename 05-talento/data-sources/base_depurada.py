...
d = C[(C.multi_idioma == 1) & C.score_T50.notna()].copy()
d = d.sort_values('rank_score')
d['rank_depurado'] = range(1, len(d) + 1)

COLS = ['rank_depurado', 'rank_score', 'score_T50', 'name', 'occupation', 'dominio', 'pais', 'region', 'birthyear',
        ...
        'hpi_archivo', 'id']
d = d[COLS].rename(columns={'score_T50': 'score', 'rank_score': 'rank_global_con_excluidos'})
