...
<meta name="description" content="Dónde nacen los jugadores, dónde juegan y por qué algunos países rinden muy por encima del tamaño de su economía. 8 gráficos interactivos de El Atlas.">
...
<meta name="description" content="Where players are born, where they play, and why some countries punch far above the size of their economy. 8 interactive charts from The Atlas.">
...
src, n = re.subn(r'(<img class="idx-thumb" src="\./thumbs/chart-[a-z0-9-]+)\.png"',
                 r'\1.en.png"', src)
if n != 8:
    sys.exit("ERROR: esperaba 8 miniaturas, cambié %d." % n)
