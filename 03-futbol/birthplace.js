...
function bp_tipMove() {
  ...
  if (ev) { const _x = ev.clientX - rc.left, _w = tt.offsetWidth || 170; tt.style.left = ((_x + 14 + _w > rc.width) ? Math.max(2, _x - _w - 14) : (_x + 14)) + 'px'; tt.style.top = (ev.clientY - rc.top + 14) + 'px'; }   // si no entra a la derecha, a la izquierda del cursor
}
