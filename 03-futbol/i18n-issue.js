...
const ISSUE_I18N = {
  es: {
    ...
    'c2-sources-tpl':        'Datos: Pantheon (MIT Media Lab) y Our World in Data — futbolistas del top {N} mundial por HPI nacidos entre {Y0} y {Y1}, por millón de habitantes. En terracota, países de la CONMEBOL.',
  ...
  en: {
    ...
    'c2-sources-tpl':        'Data: Pantheon (MIT Media Lab) and Our World in Data — footballers in the global top {N} by HPI born between {Y0} and {Y1}, per million inhabitants. In terracotta, CONMEBOL (South American) countries.',
