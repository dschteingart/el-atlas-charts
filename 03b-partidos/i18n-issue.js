...
const ISSUE_I18N = {
  es: {
    ...
    'c6-tl-sub-ma':        'Evolución histórica de las ciudades que albergaron {noun}, desde fines del siglo XIX hasta hoy',
  ...
  en: {
    ...
    'c6-tl-sub-ma':        'A history of the cities that hosted {noun}, from the late 19th century to today',
