...
const ISSUE_I18N = {
  ...
  en: {
    ...
    'c5-sources':          'Data: martj42/international_results, own elaboration. Arcs are each confederation\'s matches; ribbons, matches between two confederations. A match between two teams of the same confederation is "within" (the ribbon that loops back) and counts once. Confederation as of the match date.',
