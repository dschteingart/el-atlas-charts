...
const ISSUE_I18N = {
  es: {
    ...
    'c4-sources':          'Datos: la base de resultados internacionales de Mart Jürisoo (martj42) y elaboración propia. Cada línea une a dos selecciones con al menos el umbral elegido de partidos oficiales y amistosos entre sí (1872–junio 2026). El tamaño del nodo es su total de partidos; el color, su confederación actual.',
  ...
  en: {
    ...
    'c4-sources':          'Data: Mart Jürisoo (martj42), own elaboration. Each line links two teams with at least the chosen number of matches between them (1872–June 2026). Node size is total matches; color is current confederation.',
