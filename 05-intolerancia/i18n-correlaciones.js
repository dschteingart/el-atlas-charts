...
(function () {
  ...
  Object.assign(I18N.es, {
    ...
    'c19-sources-tpl-ext': 'Datos: Integrated Values Survey (EVS + WVS) y World Risk Poll 2023 (Lloyd\u2019s Register Foundation / Gallup), ola {PERIODO}. Eje X: {X}. Eje Y: {Y}. {N} países, R² = {R2}. Los dos ejes salen de encuestas distintas y de personas distintas: no hay estilo de respuesta compartido, pero sí dos operativos y dos años distintos. El World Risk Poll mide experiencia propia de discriminación, no opinión sobre terceros.',
  ...
  Object.assign(I18N.en, {
    ...
    'c19-sources-tpl-ext': 'Data: Integrated Values Survey (EVS + WVS) and World Risk Poll 2023 (Lloyd\u2019s Register Foundation / Gallup), {PERIODO} wave. X axis: {X}. Y axis: {Y}. {N} countries, R² = {R2}. The two axes come from different surveys and different people: no shared response style, but two fieldworks and two different years. The World Risk Poll measures first-person experience of discrimination, not opinions about others.',
