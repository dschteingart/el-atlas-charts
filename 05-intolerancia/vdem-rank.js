...
function setupVdemRankDownloadCSV() {
  document.querySelectorAll('button.download[data-chart="21-csv"]').forEach(btn => {
    btn.addEventListener('click', () => {
      const lang = (typeof LANG !== 'undefined') ? LANG : 'es';
      let csv = '';
      csv += '# El Atlas N°5 — que pasa seguido en el barrio (WVS, bateria H002)\n';
      ...
      a.href = url;
      a.download = lang === 'en'
        ? 'the-atlas-05-neighbourhood-comparison.csv'
        : 'el-atlas-05-barrio-comparacion.csv';
