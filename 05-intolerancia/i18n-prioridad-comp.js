...
(function () {
  ...
  Object.assign(I18N.es, {
    ...
    'g7-lead':           'Cuando escasea el trabajo, ¿quién debería tener prioridad? Compará países en el último dato disponible de cada uno, o seguí la evolución desde 1990.',
    ...
    // {RANGO} lo calcula el chart con los años REALMENTE mostrados.
    'c14-subtitle-origen': 'Porcentaje de acuerdo con que, cuando escasea el trabajo, los nativos deberían tener prioridad sobre los inmigrantes. Último dato disponible de cada país ({RANGO}): el año difiere entre países.',
    'c14-subtitle-genero': 'Porcentaje de acuerdo con que, cuando escasea el trabajo, los varones deberían tener más derecho a un empleo que las mujeres. Último dato disponible de cada país ({RANGO}): el año difiere entre países.',
    ...
    'c14-sources':       'Datos: Integrated Values Survey (EVS 1981-2021 + WVS 1981-2022). Dos afirmaciones de la misma batería: «cuando escasea el trabajo, los nativos deberían tener prioridad sobre los inmigrantes» (C002) y «…los varones deberían tener más derecho a un empleo que las mujeres» (C001). Se muestra el % que responde «de acuerdo» sobre el total de respuestas válidas (de acuerdo / ni de acuerdo ni en desacuerdo / en desacuerdo): el «ni una ni otra» queda en el denominador. % ponderado (S017); solo celdas con al menos 200 casos. <strong>Cada país aporta su última medición disponible, así que los años no coinciden</strong> (Argentina 2017, Uruguay 2022, Suecia 2017…): pasá el mouse por cada barra para ver el año. No se interpola ni se arma una foto de un año común. Prioridad a los nativos: 115 países; prioridad a los varones: 117 países. La mediana mundial y el puesto se calculan sobre esos países. Con unos 1.000 casos por medición el error estándar ronda los 1,6 puntos: diferencias de pocos puntos entre países no son informativas. Mide actitudes <em>declaradas</em> ante un encuestador.',
    'c14-sources-tpl':   'Datos: Integrated Values Survey (EVS + WVS). % de acuerdo, ponderado S017. Último dato disponible de cada país ({RANGO}): el año difiere entre países.',
  });

  Object.assign(I18N.en, {
    // ---- grapher shell ----
    'g7-eyebrow':        'Priority for jobs',
    'g7-lead':           'When jobs are scarce, who should get priority? Compare countries on each one’s latest available reading, or follow the trend since 1990.',
    ...
    'c14-subtitle-origen': 'Share who agree that, when jobs are scarce, employers should give priority to the native-born over immigrants. Latest available reading for each country ({RANGO}): the year differs across countries.',
    'c14-subtitle-genero': 'Share who agree that, when jobs are scarce, men should have more right to a job than women. Latest available reading for each country ({RANGO}): the year differs across countries.',
