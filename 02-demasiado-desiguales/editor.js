// =============================================================
//  editor.js — sidebar editorial para los charts del N°2
// =============================================================
//
...
(function () {
      ...
      <div class="ae-body">
        ...
        <div class="ae-section" data-ae-section="format">
          ...
          <select class="ae-select" data-ae-format>
            ...
            <option value="newsletter">Newsletter — 1000×1100</option>
            <option value="square">Cuadrado — 1200×1200</option>
            <option value="mobile">Mobile — 800×1200</option>
          </select>
        </div>
  ...
  const FORMAT_HINT = {
    es: {
      ...
      newsletter: '1000 × 1100 · Newsletter',
      square:     '1200 × 1200 · Cuadrado',
      mobile:     '800 × 1200 · Mobile'
    },
    en: {
