...
const ISSUE_I18N = {
  es: {
    ...
    'c2-axis-x-log':         'PIB per cápita',
    'c2-axis-x-linear':      'PIB per cápita',
    ...
    'c4-dec-poorest':            'más pobre',
    'c4-dec-richest':            'más rico',
    'c4-unit-label':             'Ingreso por',
    'c4-unit-day':               'Día',
    'c4-unit-month':             'Mes',
    'c4-unit-year':              'Año',
    ...
    'c4-compare-label':          'Comparar con',
    'c4-compare-none':           'Ninguno',
    ...
    'c4-map-labels':             'Valores',
    'c4-period-label':           'Período',
    'c4-search-placeholder':     'Agregar país…',
    'c4-bench-placeholder':      'Comparar contra…',
    'c4-compare-placeholder':    'Comparar con un país…',
    'c4-map-hint':               'Hacé clic en un país (o buscalo arriba) para compararlo. Dejá «Ninguno» para ver valores absolutos.',
    'c4-tag-max':                'máx',
    'c4-tag-min':                'mín',
  ...
  en: {
    ...
    'c2-axis-x-log':         'GDP per capita',
    'c2-axis-x-linear':      'GDP per capita',
    'c2-axis-y-raw':         'Gini (original)',
    ...
    'c4-view-lines':             'Lines',
    'c4-deciles-label':          'Deciles',
    'c4-dec-poorest':            'poorest',
    'c4-dec-richest':            'richest',
    'c4-unit-label':             'Income per',
    'c4-unit-day':               'Day',
    'c4-unit-month':             'Month',
    'c4-unit-year':              'Year',
    ...
    'c4-compare-label':          'Compare with',
    'c4-compare-none':           'None',
    'c4-continent-label':        'Zoom',
    'c4-cont-all':               'World',
    ...
    'c4-map-labels':             'Values',
    'c4-period-label':           'Period',
    'c4-search-placeholder':     'Add a country…',
    'c4-bench-placeholder':      'Compare against…',
    'c4-compare-placeholder':    'Compare with a country…',
    'c4-map-hint':               'Click a country (or search above) to compare against it. Leave “None” for absolute values.',
    'c4-tag-max':                'max',
    'c4-tag-min':                'min',
